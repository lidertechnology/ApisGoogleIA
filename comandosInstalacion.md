...
Bash
    ...
    cd functions && npm install firebase-admin firebase-functions @google-cloud/documentai @google-cloud/vertexai @google-cloud/text-to-speech @google-cloud/speech cors && npm install --save-dev @types/cors
